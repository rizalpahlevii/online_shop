    ...
    <div class="content-body">
        <div class="card">
            <div class="card-header">
                <h4 id="basic-forms" class="card-title">Post Update</h4>
            ...
            <div class="card-body collapse in" aria-expanded="true">
                <div class="card-block">
                    <form action="{{route('backoffice.blog_update')}}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="title" class="form-control" placeholder="title" name="title" value="{{$blog->title}}">
                                        @error('title')
