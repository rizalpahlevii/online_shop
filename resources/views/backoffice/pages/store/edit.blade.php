        ...
        <div class="card">
            ...
            <div class="card-body collapse in" aria-expanded="true">
                <div class="card-block">
                    <form action="{{route('backoffice.store_update')}}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control" placeholder="Name" name="name" value="{{$store->name}}">
                                        @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="user" id="user" class="form-control">
                                            ...
                                            @foreach ($users as $item)
                                                <option value="{{$item['id']}}" <?=($store->user_id == $item['id'])?'selected':'';?>>{{$item['name']}}</option>
                                            @endforeach
                                        </select>
                                        @error('user')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="province" id="province" class="form-control" required>
                                            ...
                                            @foreach ($provinces['rajaongkir']['results'] as $rowP)
                                                <option value="{{$rowP['province_id']}}" <?= ($rowP['province_id'] == $store->province_code) ? 'selected':''; ?>>{{$rowP['province']}}</option>
                                            @endforeach
                                        </select>
                                        @error('province')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="city" id="city" class="form-control @error('city') is-invalid @enderror" required>
                                            ...
                                            @foreach ($cities['rajaongkir']['results'] as $rowC)
                                                <option value="{{$rowC['city_id']}}" <?= ($rowC['city_id'] == $store->districts_code) ? 'selected':''; ?>>{{$rowC['city_name']}}</option>
                                            @endforeach
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="10" class="form-control">{{$store->store_description}}</textarea>
                                        @error('description')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" id="address" cols="30" rows="10" class="form-control">{{$store->address}}</textarea>
                                        @error('address')
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="postal_code" id="postal_code" class="form-control" value="{{$store->postal_code}}" required>
                                        @error('postal_code')
